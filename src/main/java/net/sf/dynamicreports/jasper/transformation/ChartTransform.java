...
public class ChartTransform {
    ...
    private void dataset(DRIDesignChartDataset dataset, JRDesignElementDataset jrDataset) {
        ...
        jrDataset.setResetType(variableResetType(resetType));
        ...
        switch (jrDataset) {
            case JRDesignCategoryDataset jrDesignCategoryDataset ->
                    categoryDataset((DRIDesignCategoryDataset) dataset, jrDesignCategoryDataset);
            case JRDesignPieDataset jrDesignPieDataset ->
                    pieDataset((DRIDesignSeriesDataset) dataset, jrDesignPieDataset);
            case JRDesignTimeSeriesDataset jrDesignTimeSeriesDataset ->
                    timeSeriesDataset((DRIDesignTimeSeriesDataset) dataset, jrDesignTimeSeriesDataset);
            case JRDesignXyDataset jrDesignXyDataset -> xyDataset((DRIDesignSeriesDataset) dataset, jrDesignXyDataset);
            case StandardSpiderDataset standardSpiderDataset ->
                    spiderDataset((DRIDesignCategoryDataset) dataset, standardSpiderDataset);
            case JRDesignXyzDataset jrDesignXyzDataset ->
                    xyzDataset((DRIDesignSeriesDataset) dataset, jrDesignXyzDataset);
            case JRDesignGanttDataset jrDesignGanttDataset ->
                    ganttDataset((DRIDesignSeriesDataset) dataset, jrDesignGanttDataset);
            case JRDesignHighLowDataset jrDesignHighLowDataset ->
                    highLowDataset((DRIDesignHighLowDataset) dataset, jrDesignHighLowDataset);
            case JRDesignValueDataset jrDesignValueDataset ->
                    valueDataset((DRIDesignValueDataset) dataset, jrDesignValueDataset);
            case null, default ->
    ...
    private void plot(DRIDesignBasePlot plot, JRChartPlot jrPlot, JRDesignChart jrChart) {
        ...
        switch (jrPlot) {
            ...
            case JRDesignBar3DPlot jrDesignBar3DPlot -> bar3DPlot((DRIDesignBar3DPlot) plot, jrDesignBar3DPlot);
            ...
            case JRDesignPie3DPlot jrDesignPie3DPlot -> pie3DPlot((DRIDesignPie3DPlot) plot, jrDesignPie3DPlot);
            case JRDesignScatterPlot jrDesignScatterPlot -> scatterPlot((DRIDesignLinePlot) plot, jrDesignScatterPlot);
            case JRDesignTimeSeriesPlot jrDesignTimeSeriesPlot ->
                    timeSeriesPlot((DRIDesignLinePlot) plot, jrDesignTimeSeriesPlot);
            case JRDesignMultiAxisPlot jrDesignMultiAxisPlot ->
                    multiAxisPlot((DRIDesignMultiAxisPlot) plot, jrDesignMultiAxisPlot, jrChart);
            case JRDesignBubblePlot jrDesignBubblePlot -> bubblePlot((DRIDesignBubblePlot) plot, jrDesignBubblePlot);
            case JRDesignCandlestickPlot jrDesignCandlestickPlot ->
                    candlestickPlot((DRIDesignCandlestickPlot) plot, jrDesignCandlestickPlot);
            case JRDesignHighLowPlot jrDesignHighLowPlot ->
                    highLowPlot((DRIDesignHighLowPlot) plot, jrDesignHighLowPlot);
            case JRDesignMeterPlot jrDesignMeterPlot ->
                    meterPlot((DRIDesignMeterPlot) plot, jrDesignMeterPlot, jrChart);
            case JRDesignThermometerPlot jrDesignThermometerPlot ->
                    thermometerPlot((DRIDesignThermometerPlot) plot, jrDesignThermometerPlot, jrChart);
            case null, default ->
    ...
    private DatasetResetTypeEnum variableResetType(final ResetType resetType) {
        if (resetType == null) {
